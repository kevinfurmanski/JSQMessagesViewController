Pod::Spec.new do |s|
	...
	s.homepage = 'https://github.com/kevinfurmanski/JSQMessagesViewController'
	s.license = 'MIT'
	s.platform = :ios, '7.0'

	s.author = 'Jesse Squires'

	s.source = { :git => 'https://github.com/kevinfurmanski/JSQMessagesViewController.git', :tag => s.version }
